package com.example.stealth.navigationdrawer1.following;
...
public class db_following extends AsyncTask<Void,Integer,String> {

    Context c;
    main_link obj_link=new main_link();
    String primary_link=obj_link.host_link();

    String urlAddress=primary_link+"following.php";

   // String urlAddress = "http://pentelican-thing.000webhostapp.com/nexval/following.php";
   //String urlAddress = "http://4c58912a.ngrok.io/nexval/following.php";
    ...
    public db_following(Context c, String a, RecyclerView rv) {
        this.c = c;
        this.a = a;
        this.rv = rv;
    }
